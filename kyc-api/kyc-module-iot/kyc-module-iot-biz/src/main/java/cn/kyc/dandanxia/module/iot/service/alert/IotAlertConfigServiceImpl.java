package cn.kyc.dandanxia.module.iot.service.alert;
...
import cn.kyc.dandanxia.module.iot.controller.admin.alert.vo.config.IotAlertConfigPageReqVO;
import cn.kyc.dandanxia.module.iot.controller.admin.alert.vo.config.IotAlertConfigSaveReqVO;
import cn.kyc.dandanxia.module.iot.dal.dataobject.alert.IotAlertConfigDO;
import cn.kyc.dandanxia.module.iot.dal.mysql.alert.IotAlertConfigMapper;
import cn.kyc.dandanxia.module.iot.enums.alert.IotAlertReceiveTypeEnum;
import cn.kyc.dandanxia.module.iot.service.rule.scene.IotSceneRuleService;
...
import static cn.kyc.dandanxia.module.iot.enums.ErrorCodeConstants.ALERT_CONFIG_MAIL_TEMPLATE_REQUIRED;
import static cn.kyc.dandanxia.module.iot.enums.ErrorCodeConstants.ALERT_CONFIG_NOT_EXISTS;
import static cn.kyc.dandanxia.module.iot.enums.ErrorCodeConstants.ALERT_CONFIG_NOTIFY_TEMPLATE_REQUIRED;
import static cn.kyc.dandanxia.module.iot.enums.ErrorCodeConstants.ALERT_CONFIG_SMS_TEMPLATE_REQUIRED;
