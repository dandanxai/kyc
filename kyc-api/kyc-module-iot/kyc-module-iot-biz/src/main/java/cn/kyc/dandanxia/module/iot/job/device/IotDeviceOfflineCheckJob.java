package cn.kyc.dandanxia.module.iot.job.device;
...
import cn.kyc.dandanxia.module.iot.framework.iot.config.KycIotProperties;
...
public class IotDeviceOfflineCheckJob implements JobHandler {
    ...
    @Resource
    private KycIotProperties iotProperties;
