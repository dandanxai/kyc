package cn.kyc.dandanxia.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import cn.kyc.dandanxia.framework.common.exception.enums.GlobalErrorCodeConstants;
import cn.kyc.dandanxia.framework.common.pojo.CommonResult;
import cn.kyc.dandanxia.framework.common.util.json.JsonUtils;
import cn.kyc.dandanxia.module.iot.core.biz.IotDeviceCommonApi;
import cn.kyc.dandanxia.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import cn.kyc.dandanxia.module.iot.core.biz.dto.IotDeviceRespDTO;
import cn.kyc.dandanxia.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import cn.kyc.dandanxia.module.iot.core.biz.dto.IotModbusPointRespDTO;
import cn.kyc.dandanxia.module.iot.core.enums.IotDeviceMessageMethodEnum;
import cn.kyc.dandanxia.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import cn.kyc.dandanxia.module.iot.core.mq.message.IotDeviceMessage;
import cn.kyc.dandanxia.module.iot.core.topic.IotDeviceIdentity;
import cn.kyc.dandanxia.module.iot.core.util.IotDeviceAuthUtils;
import cn.kyc.dandanxia.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import cn.kyc.dandanxia.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import cn.kyc.dandanxia.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import cn.kyc.dandanxia.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import cn.kyc.dandanxia.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import cn.kyc.dandanxia.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import cn.kyc.dandanxia.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import cn.kyc.dandanxia.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import cn.kyc.dandanxia.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import cn.kyc.dandanxia.module.iot.gateway.service.device.IotDeviceService;
import cn.kyc.dandanxia.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static cn.kyc.dandanxia.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.kyc.dandanxia.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.kyc.dandanxia.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link cn.kyc.dandanxia.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
