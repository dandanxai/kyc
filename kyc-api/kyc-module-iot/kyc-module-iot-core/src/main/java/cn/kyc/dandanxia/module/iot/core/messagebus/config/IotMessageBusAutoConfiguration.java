package cn.kyc.dandanxia.module.iot.core.messagebus.config;

import cn.kyc.dandanxia.framework.mq.redis.core.RedisMQTemplate;
import cn.kyc.dandanxia.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import cn.kyc.dandanxia.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import cn.kyc.dandanxia.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import cn.kyc.dandanxia.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import cn.kyc.dandanxia.module.iot.core.messagebus.core.IotMessageBus;
import cn.kyc.dandanxia.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import cn.kyc.dandanxia.module.iot.core.messagebus.core.rabbitmq.IotRabbitMQMessageBus;
import cn.kyc.dandanxia.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import cn.kyc.dandanxia.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "kyc.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "kyc.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 KycRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see cn.kyc.dandanxia.framework.mq.redis.config.KycRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "kyc.iot.message-bus", name = "type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "kyc.iot.message-bus", name = "type", havingValue = "rabbitmq")
