package cn.kyc.dandanxia.module.ai.framework.ai.core.model;
...
import cn.kyc.dandanxia.framework.common.util.spring.SpringUtils;
import cn.kyc.dandanxia.module.ai.enums.model.AiPlatformEnum;
import cn.kyc.dandanxia.module.ai.framework.ai.config.AiAutoConfiguration;
import cn.kyc.dandanxia.module.ai.framework.ai.config.KycAiProperties;
...
import cn.kyc.dandanxia.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import cn.kyc.dandanxia.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            KycAiProperties.Midjourney properties = SpringUtil.getBean(KycAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(KycAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        KycAiProperties.DouBao properties = new KycAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(KycAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        KycAiProperties.HunYuan properties = new KycAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(KycAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        KycAiProperties.SiliconFlow properties = new KycAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(KycAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        KycAiProperties.XingHuo properties = new KycAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(KycAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        KycAiProperties.BaiChuan properties = new KycAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(KycAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        KycAiProperties.Gemini properties = SpringUtil.getBean(KycAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        KycAiProperties.Grok properties = new KycAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
