package cn.kyc.dandanxia.module.ai.service.chat;
...
import cn.kyc.dandanxia.framework.tenant.core.util.TenantUtils;
import cn.kyc.dandanxia.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import cn.kyc.dandanxia.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import cn.kyc.dandanxia.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import cn.kyc.dandanxia.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import cn.kyc.dandanxia.module.ai.dal.dataobject.chat.AiChatConversationDO;
import cn.kyc.dandanxia.module.ai.dal.dataobject.chat.AiChatMessageDO;
import cn.kyc.dandanxia.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import cn.kyc.dandanxia.module.ai.dal.dataobject.model.AiChatRoleDO;
import cn.kyc.dandanxia.module.ai.dal.dataobject.model.AiModelDO;
import cn.kyc.dandanxia.module.ai.dal.dataobject.model.AiToolDO;
import cn.kyc.dandanxia.module.ai.dal.mysql.chat.AiChatMessageMapper;
import cn.kyc.dandanxia.module.ai.enums.ErrorCodeConstants;
import cn.kyc.dandanxia.module.ai.enums.model.AiPlatformEnum;
import cn.kyc.dandanxia.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import cn.kyc.dandanxia.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import cn.kyc.dandanxia.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import cn.kyc.dandanxia.module.ai.service.knowledge.AiKnowledgeDocumentService;
import cn.kyc.dandanxia.module.ai.service.knowledge.AiKnowledgeSegmentService;
import cn.kyc.dandanxia.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import cn.kyc.dandanxia.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import cn.kyc.dandanxia.module.ai.service.model.AiChatRoleService;
import cn.kyc.dandanxia.module.ai.service.model.AiModelService;
import cn.kyc.dandanxia.module.ai.service.model.AiToolService;
import cn.kyc.dandanxia.module.ai.util.AiUtils;
import cn.kyc.dandanxia.module.ai.util.FileTypeUtils;
...
import static cn.kyc.dandanxia.framework.common.pojo.CommonResult.error;
...
import static cn.kyc.dandanxia.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static cn.kyc.dandanxia.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 kyc.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 kyc.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
