package cn.kyc.dandanxia.module.bpm.service.task;
...
import cn.kyc.dandanxia.framework.common.util.collection.CollectionUtils;
import cn.kyc.dandanxia.framework.common.util.date.DateUtils;
import cn.kyc.dandanxia.framework.common.util.json.JsonUtils;
import cn.kyc.dandanxia.framework.common.util.object.ObjectUtils;
import cn.kyc.dandanxia.framework.common.util.object.PageUtils;
import cn.kyc.dandanxia.framework.datapermission.core.annotation.DataPermission;
import cn.kyc.dandanxia.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import cn.kyc.dandanxia.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import cn.kyc.dandanxia.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import cn.kyc.dandanxia.module.bpm.controller.admin.task.vo.instance.*;
import cn.kyc.dandanxia.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import cn.kyc.dandanxia.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import cn.kyc.dandanxia.module.bpm.convert.task.BpmProcessInstanceConvert;
import cn.kyc.dandanxia.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import cn.kyc.dandanxia.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import cn.kyc.dandanxia.module.bpm.enums.ErrorCodeConstants;
import cn.kyc.dandanxia.module.bpm.enums.definition.BpmModelTypeEnum;
import cn.kyc.dandanxia.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import cn.kyc.dandanxia.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import cn.kyc.dandanxia.module.bpm.enums.task.BpmReasonEnum;
import cn.kyc.dandanxia.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.kyc.dandanxia.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import cn.kyc.dandanxia.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import cn.kyc.dandanxia.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import cn.kyc.dandanxia.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.kyc.dandanxia.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import cn.kyc.dandanxia.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import cn.kyc.dandanxia.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.kyc.dandanxia.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.kyc.dandanxia.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import cn.kyc.dandanxia.module.bpm.service.definition.BpmProcessDefinitionService;
import cn.kyc.dandanxia.module.bpm.service.message.BpmMessageService;
import cn.kyc.dandanxia.module.system.api.dept.DeptApi;
import cn.kyc.dandanxia.module.system.api.dept.dto.DeptRespDTO;
...
import static cn.kyc.dandanxia.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static cn.kyc.dandanxia.module.bpm.enums.ErrorCodeConstants.*;
import static cn.kyc.dandanxia.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static cn.kyc.dandanxia.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/kyc-cloud/issues/ID1UYA
