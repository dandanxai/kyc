...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.kyc.boot";
    private static final String ARTIFACT_ID = "kyc";
    private static final String PACKAGE_NAME = "cn.kyc.dandanxia";
    private static final String TITLE = "基于银河麒麟操作系统的AI智能匹配与能力图谱系统";
...
//    private static final String TITLE = "基于银河麒麟操作系统的AI智能匹配与能力图谱系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.kyc.boot";
        String artifactIdNew = "kyc";
        String packageNameNew = "cn.kyc.dandanxia";
        String titleNew = "基于银河麒麟操作系统的AI智能匹配与能力图谱系统";
