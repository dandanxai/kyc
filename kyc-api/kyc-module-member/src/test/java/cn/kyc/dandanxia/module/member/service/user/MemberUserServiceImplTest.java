package cn.kyc.dandanxia.module.member.service.user;
...
import cn.kyc.dandanxia.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
import cn.kyc.dandanxia.module.member.dal.dataobject.user.MemberUserDO;
import cn.kyc.dandanxia.module.member.dal.mysql.user.MemberUserMapper;
import cn.kyc.dandanxia.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, KycRedisAutoConfiguration.class})
