package cn.kyc.dandanxia.module.crm.controller.admin.product.vo.product;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.SIMPLE, targetClassName = "cn.kyc.dandanxia.module.system.dal.dataobject.user.AdminUserDO",
