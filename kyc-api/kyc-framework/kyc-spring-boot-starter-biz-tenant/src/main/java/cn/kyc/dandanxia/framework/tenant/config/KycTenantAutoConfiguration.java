package cn.kyc.dandanxia.framework.tenant.config;

import cn.kyc.dandanxia.framework.common.biz.system.tenant.TenantCommonApi;
...
import cn.kyc.dandanxia.framework.redis.config.KycCacheProperties;
import cn.kyc.dandanxia.framework.security.core.service.SecurityFrameworkService;
import cn.kyc.dandanxia.framework.tenant.core.aop.TenantIgnore;
import cn.kyc.dandanxia.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.kyc.dandanxia.framework.tenant.core.db.TenantDatabaseInterceptor;
import cn.kyc.dandanxia.framework.tenant.core.job.TenantJobAspect;
import cn.kyc.dandanxia.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import cn.kyc.dandanxia.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import cn.kyc.dandanxia.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import cn.kyc.dandanxia.framework.tenant.core.redis.TenantRedisCacheManager;
import cn.kyc.dandanxia.framework.tenant.core.security.TenantSecurityWebFilter;
import cn.kyc.dandanxia.framework.tenant.core.service.TenantFrameworkService;
import cn.kyc.dandanxia.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.kyc.dandanxia.framework.tenant.core.web.TenantContextWebFilter;
import cn.kyc.dandanxia.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "kyc.tenant", value = "enable", matchIfMissing = true) // 允许使用 kyc.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class KycTenantAutoConfiguration {
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     KycCacheProperties kycCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(kycCacheProperties.getRedisScanBatchSize()));
