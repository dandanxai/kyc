package cn.kyc.dandanxia.framework.web.config;
...
import cn.kyc.dandanxia.framework.web.core.filter.CacheRequestBodyFilter;
import cn.kyc.dandanxia.framework.web.core.filter.DemoFilter;
import cn.kyc.dandanxia.framework.web.core.handler.GlobalExceptionHandler;
import cn.kyc.dandanxia.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class KycWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "kyc.demo", havingValue = "true")
