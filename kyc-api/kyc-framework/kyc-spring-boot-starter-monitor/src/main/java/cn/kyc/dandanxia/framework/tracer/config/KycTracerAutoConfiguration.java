package cn.kyc.dandanxia.framework.tracer.config;

import cn.kyc.dandanxia.framework.common.enums.WebFilterOrderEnum;
import cn.kyc.dandanxia.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "kyc.tracer", value = "enable", matchIfMissing = true)
public class KycTracerAutoConfiguration {
