package cn.kyc.dandanxia.module.mes.dal.mysql.wm.productsales;
...
public interface MesWmProductSalesLineMapper extends BaseMapperX<MesWmProductSalesLineDO> {
    ...
    default cn.kyc.dandanxia.framework.common.pojo.PageResult<MesWmProductSalesLineDO> selectPage(
            cn.kyc.dandanxia.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO reqVO) {
        return selectPage(reqVO, new cn.kyc.dandanxia.framework.mybatis.core.query.LambdaQueryWrapperX<MesWmProductSalesLineDO>()
