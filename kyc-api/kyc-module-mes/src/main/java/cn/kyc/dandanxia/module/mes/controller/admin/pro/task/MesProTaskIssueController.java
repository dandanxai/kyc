...
import cn.kyc.dandanxia.module.mes.controller.admin.pro.task.vo.MesProTaskIssuePageReqVO;
import cn.kyc.dandanxia.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
import cn.kyc.dandanxia.module.mes.controller.admin.pro.task.vo.MesProTaskIssueSaveReqVO;
...
import cn.kyc.dandanxia.module.mes.dal.dataobject.pro.task.MesProTaskIssueDO;
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return cn.kyc.dandanxia.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
