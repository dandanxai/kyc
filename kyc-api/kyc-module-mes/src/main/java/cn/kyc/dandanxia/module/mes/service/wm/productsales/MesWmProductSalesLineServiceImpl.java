...
import cn.kyc.dandanxia.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO;
import cn.kyc.dandanxia.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLineSaveReqVO;
...
import cn.kyc.dandanxia.module.mes.dal.dataobject.wm.salesnotice.MesWmSalesNoticeLineDO;
import cn.kyc.dandanxia.module.mes.dal.mysql.wm.productsales.MesWmProductSalesLineMapper;
import cn.kyc.dandanxia.module.mes.enums.qc.MesQcCheckResultEnum;
...
import cn.kyc.dandanxia.module.mes.service.wm.salesnotice.MesWmSalesNoticeLineService;
...
public class MesWmProductSalesLineServiceImpl implements MesWmProductSalesLineService {
    ...
    @Override
    public cn.kyc.dandanxia.framework.common.pojo.PageResult<MesWmProductSalesLineDO> getProductSalesLinePage(
        ...
        if (pageReqVO.getSalesId() == null && pageReqVO.getClientId() != null) {
            ...
            if (CollUtil.isEmpty(salesList)) {
                return cn.kyc.dandanxia.framework.common.pojo.PageResult.empty();
            }
