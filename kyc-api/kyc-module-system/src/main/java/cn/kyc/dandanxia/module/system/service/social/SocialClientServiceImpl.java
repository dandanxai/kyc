package cn.kyc.dandanxia.module.system.service.social;
...
import cn.kyc.dandanxia.framework.common.util.cache.CacheUtils;
import cn.kyc.dandanxia.framework.common.util.http.HttpUtils;
import cn.kyc.dandanxia.framework.common.util.object.BeanUtils;
import cn.kyc.dandanxia.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cn.kyc.dandanxia.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import cn.kyc.dandanxia.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cn.kyc.dandanxia.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.kyc.dandanxia.module.system.dal.dataobject.social.SocialClientDO;
import cn.kyc.dandanxia.module.system.dal.mysql.social.SocialClientMapper;
import cn.kyc.dandanxia.module.system.dal.redis.RedisKeyConstants;
import cn.kyc.dandanxia.module.system.enums.social.SocialTypeEnum;
import cn.kyc.dandanxia.module.system.framework.justauth.core.AuthRequestFactory;
...
import static cn.kyc.dandanxia.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static cn.kyc.dandanxia.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${kyc.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${kyc.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/kyc-cloud/pulls/230
