package cn.kyc.dandanxia.module.system.service.user;
...
import cn.kyc.dandanxia.framework.common.util.collection.ArrayUtils;
import cn.kyc.dandanxia.framework.common.util.collection.CollectionUtils;
import cn.kyc.dandanxia.framework.test.core.ut.BaseDbUnitTest;
import cn.kyc.dandanxia.module.infra.api.config.ConfigApi;
import cn.kyc.dandanxia.module.infra.api.file.FileApi;
import cn.kyc.dandanxia.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.kyc.dandanxia.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.kyc.dandanxia.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import cn.kyc.dandanxia.module.system.controller.admin.user.vo.user.UserImportRespVO;
import cn.kyc.dandanxia.module.system.controller.admin.user.vo.user.UserPageReqVO;
import cn.kyc.dandanxia.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import cn.kyc.dandanxia.module.system.dal.dataobject.dept.DeptDO;
import cn.kyc.dandanxia.module.system.dal.dataobject.dept.PostDO;
import cn.kyc.dandanxia.module.system.dal.dataobject.dept.UserPostDO;
import cn.kyc.dandanxia.module.system.dal.dataobject.tenant.TenantDO;
import cn.kyc.dandanxia.module.system.dal.dataobject.user.AdminUserDO;
import cn.kyc.dandanxia.module.system.dal.mysql.dept.UserPostMapper;
import cn.kyc.dandanxia.module.system.dal.mysql.user.AdminUserMapper;
import cn.kyc.dandanxia.module.system.enums.common.SexEnum;
import cn.kyc.dandanxia.module.system.mq.producer.user.AdminUserProducer;
import cn.kyc.dandanxia.module.system.service.dept.DeptService;
import cn.kyc.dandanxia.module.system.service.dept.PostService;
import cn.kyc.dandanxia.module.system.service.oauth2.OAuth2TokenService;
import cn.kyc.dandanxia.module.system.service.permission.PermissionService;
import cn.kyc.dandanxia.module.system.service.tenant.TenantService;
...
import static cn.kyc.dandanxia.framework.common.util.collection.SetUtils.asSet;
import static cn.kyc.dandanxia.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.kyc.dandanxia.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.kyc.dandanxia.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.kyc.dandanxia.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.kyc.dandanxia.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.kyc.dandanxia.framework.test.core.util.RandomUtils.*;
import static cn.kyc.dandanxia.module.system.enums.ErrorCodeConstants.*;
import static cn.kyc.dandanxia.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("kycyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("kycyuanma");
        ...
        assertEquals("kycyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("kycyuanma"))).thenReturn("java");
