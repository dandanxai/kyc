...
import cn.kyc.dandanxia.framework.common.util.string.StrUtils;
import cn.kyc.dandanxia.framework.dict.core.DictFrameworkUtils;
import cn.kyc.dandanxia.framework.ip.core.utils.AreaUtils;
...
import cn.kyc.dandanxia.module.pay.enums.DictTypeConstants;
import cn.kyc.dandanxia.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import cn.kyc.dandanxia.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import cn.kyc.dandanxia.module.product.api.sku.dto.ProductSkuRespDTO;
import cn.kyc.dandanxia.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.kyc.dandanxia.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.kyc.dandanxia.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.kyc.dandanxia.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.kyc.dandanxia.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.kyc.dandanxia.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.kyc.dandanxia.module.trade.controller.admin.order.vo.*;
import cn.kyc.dandanxia.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.kyc.dandanxia.module.trade.controller.app.order.vo.*;
import cn.kyc.dandanxia.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.kyc.dandanxia.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.kyc.dandanxia.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import cn.kyc.dandanxia.module.trade.framework.order.config.TradeOrderProperties;
import cn.kyc.dandanxia.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.kyc.dandanxia.framework.common.util.collection.CollectionUtils.convertMap;
import static cn.kyc.dandanxia.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static cn.kyc.dandanxia.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/kyccode/kyc-mall-uniapp/issues/ICY7SJ
