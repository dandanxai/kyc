...
import cn.kyc.dandanxia.module.im.controller.admin.group.vo.member.ImGroupMemberUpdateReqVO;
import cn.kyc.dandanxia.module.im.dal.dataobject.group.ImGroupMemberDO;
import cn.kyc.dandanxia.module.im.dal.mysql.group.ImGroupMemberMapper;
...
import static cn.kyc.dandanxia.module.im.enums.ErrorCodeConstants.GROUP_MEMBER_NOT_IN_GROUP;
...
public class ImGroupMemberServiceImplTest extends BaseMockitoUnitTest {
    ...
    @Mock
    private cn.kyc.dandanxia.module.im.service.message.ImGroupMessageService groupMessageService;
    ...
    public void testUpdateGroupMember_success() {
        ...
        verify(groupMessageService).sendGroupMessage(eq(1L), any(cn.kyc.dandanxia.module.im.service.message.dto.ImGroupMessageSendDTO.class));
        // 个人字段 silent 变化 → 仅自己多端同步 GROUP_MEMBER_SETTING_UPDATE
        verify(groupMessageService).sendGroupMessage(eq(1L), eq(ListUtil.of(1L)),
                any(cn.kyc.dandanxia.module.im.service.message.dto.ImGroupMessageSendDTO.class));
    }
